...
const StandardHomeDesignPage = () => {
  ...
  const fetchProperties = async () => {
    try {
      ...
      console.log('🔍 Fetching Standard Home Design properties from:', `${backendUrl}/api/properties?${params.toString()}`);
      ...
      if (data.success) {
        console.log('✅ Standard Home Design properties fetched successfully:', data.data.properties?.length || 0, 'properties');
  ...
  const filteredData = useMemo(() => {
    console.log('🔍 Filtering Standard Home Design properties with:', {
      searchTerm,
      category,
      selectedLocation,
        ...
        <Container fluid>
          <Row className="mb-4">
            <Col>
              ...
              <p className="text-muted">Discover our collection of beautiful standard home designs</p>
            </Col>
          </Row>
...
export default StandardHomeDesignPage;
