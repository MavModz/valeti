...
const HomeDesignCategoryPage = ({ params }) => {
  ...
  const categoryConfig = {
    'standard': {
      title: 'Standard Home Design',
      description: 'Browse our collection of standard home designs',
      breadcrumb: 'Home / Home Designs / Standard Home Design'
    },
    'custom': {
      title: 'Custom Homes',
      description: 'Explore our custom home design options',
      breadcrumb: 'Home / Home Designs / Custom Homes'
    },
    'interior': {
      title: 'Interior Design',
      description: 'Discover beautiful interior design solutions',
      breadcrumb: 'Home / Home Designs / Interior Design'
    },
    'multiunit': {
      title: 'Multiunit Development',
      description: 'Multi-unit development projects and designs',
      breadcrumb: 'Home / Home Designs / Multiunit Development'
    },
    'commercial': {
      title: 'Commercial Design',
      description: 'Commercial building and office designs',
      breadcrumb: 'Home / Home Designs / Commercial Design'
    }
  };

  const currentCategory = categoryConfig[category] || categoryConfig['standard'];
  ...
  const fetchProperties = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/properties?category=${category}&limit=50`);
    ...
    return (
      <>
        ...
        <Container fluid>
          <Row className="mb-4">
            <Col>
              <h2 className="mb-1">{currentCategory.title}</h2>
      ...
      <Container fluid>
        ...
        <Row className="mb-4">
          <Col>
            <h2 className="mb-1">{currentCategory.title}</h2>
            <p className="text-muted">{currentCategory.description}</p>
            <small className="text-muted">{currentCategory.breadcrumb}</small>
          </Col>
        </Row>
...
export default HomeDesignCategoryPage;
