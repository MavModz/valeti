...
const validateProperty = [
  ...
  body('category')
    .isIn(['Single Storey', 'Double Storey', 'Back To Back', 'Multi Unit'])
...
router.get('/', [
  ...
  query('category').optional().isIn(['Single Storey', 'Double Storey', 'Back To Back', 'Multi Unit']).withMessage('Invalid category filter'),
