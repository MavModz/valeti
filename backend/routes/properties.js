...
const validateProperty = [
  ...
  body('category')
    .isIn(['Single Story', 'Double Story', 'Back To Back', 'Multi Unit'])
...
router.get('/', [
  ...
  query('category').optional().isIn(['Single Story', 'Double Story', 'Back To Back', 'Multi Unit']).withMessage('Invalid category filter'),
